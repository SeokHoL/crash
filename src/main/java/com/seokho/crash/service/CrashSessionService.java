...
import com.seokho.crash.exception.crashsession.CrashSessionNotFoundException;
...
public class CrashSessionService {
    ...
    public CrashSession updateCrashSession(
        ...
        if (!ObjectUtils.isEmpty(crashSessionPatchRequestBody.speakerId())){
            var sessionSpeakerEntity =
                    sessionSpeakerService.getSessionSpeakerEntityBySpeakerId(crashSessionPatchRequestBody.speakerId());
